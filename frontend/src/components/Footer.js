    ...
    <footer className="bg-gray-800 text-white">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">QHomes</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href="/sell" className="hover:text-white transition-colors">Sell Properties</a></li>
              <li><a href="/rent" className="hover:text-white transition-colors">Rent Properties</a></li>
              <li><a href="/management" className="hover:text-white transition-colors">Property Management</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 text-center text-gray-400">
          <p>&copy; 2024 QHomes. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
